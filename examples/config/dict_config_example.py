...
def main():
    ...
    config = {
        ...
        "kiss_config": {
            "levels": {
                "debug": {"color": "cyan", "style": "bold"},
                "info": {"color": "green", "style": "bold"},
                "warning": {"color": "yellow", "style": "bold"},
                "error": {"color": "white", "background": "red", "style": "bold"},
                "critical": {"color": "white", "background": "bright_magenta", "style": ["bold", "blink"]},
            },
            "messages": {
                "debug": {"color": "cyan"},
                "info": {"color": "green"},
        ...
        "handlers": {
            "console": {"()": "logkiss.KissConsoleHandler", "level": "DEBUG", "formatter": "kiss_default"},
            "file": {"class": "logging.FileHandler", "level": "INFO", "formatter": "kiss_detailed", "filename": "application.log", "mode": "a"},
            "rotating_file": {
        ...
        "loggers": {
            ...
            "app.errors": {"level": "ERROR", "handlers": ["console", "rotating_file"], "propagate": False},
        },
